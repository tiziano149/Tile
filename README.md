...
The code (found in Code/main/esp_zigbee_gpd.c) sets up the ESP32C6 as a "ZigBee Green Power Device" 4-Way switch simulating an EnOcean PTM 215Z, commonly used in "Friends of Hue" / "Works with Hue" Switches.
